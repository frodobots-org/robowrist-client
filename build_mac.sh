...
echo "========================================"
echo "  Robowrist-client - build (macOS)"
echo "  (everything stays inside project directory)"
echo "========================================"
echo ""

if ! command -v python3 &>/dev/null; then
    echo "python3 not found. Install Python 3.8+ (e.g. brew install python)."
...
if [ ! -f "$VENV/bin/python" ]; then
    python3 -m venv "$VENV" || { echo "Failed to create virtualenv. Install python3 (e.g. brew install python)."; exit 1; }
    echo "      Created $VENV"
else
